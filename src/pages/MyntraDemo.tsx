...
const MyntraDemo = () => {
  ...
  const fetchProductData = async () => {
    ...
    if (!/^\d+$/.test(productCode.trim())) {
      setError("Invalid product code. Please enter numbers only.");
      return;
    }
        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Myntra <span className="text-primary">Scraper</span>
            </h1>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Enter a Myntra product code below to see how the scraper extracts live data such as pricing,
              coupon details, and stock availability in real-time.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-2">
                💡 Tip: Enter the Myntra product code (numbers only) — e.g., <code className="px-1 py-0.5 rounded bg-primary/10 text-primary">30676691</code>
              </p>
            </div>
